	...
	return `
		<nav id="navbar">
			...
			<div class="nav-user-panel">
				<div style="display: inline-flex; align-items: center; gap: 8px; background: rgba(255, 255, 255, 0.06); border: 1px solid var(--border-color); padding: 7px 16px; border-radius: 20px; font-size: 13px; font-weight: 600;">
					<span style="font-size: 15px;">👤</span>
					<span style="opacity: 0.95;">Convidado</span>
				</div>
			</div>
		</nav>
	`;
...
<script>
// Limpa qualquer sessão residual no navegador do visitante
try {
